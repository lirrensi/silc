#!/usr/bin/env python3
"""
Utility script that demonstrates the complete open → type → close cycle
using the local silc CLI. It is intended to be executed directly:

    python -m tests/run_commands.py
...
All output from each step is printed to the console for easy observation.
"""
